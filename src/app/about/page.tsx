...
export const metadata: Metadata = {
  title: "About Us",
  description:
    "Learn about Erikot Properties — Uganda's trusted rental housing marketplace connecting tenants with landlords.",
};
      ...
      <section className="section">
        <div className="page-container max-w-3xl">
          ...
          <div className="prose prose-gray mt-4 space-y-4 text-gray-600">
            <p>
              Erikot Properties was born out of a simple frustration: finding a rental home in Uganda
            ...
            <p>
              We built Erikot Properties to change that. Our platform brings together verified
            ...
            <p>
              Today, Erikot Properties serves thousands of tenants and landlords across Kampala,
              ...
              Erikot Properties helps you find the right match.
            </p>
          </div>
        </div>
      </section>
