...
const roles = [
  {
    value: "TENANT",
    label: "Client",
    description: "I want to rent, buy, lease, hire or request a service",
    icon: User,
  },
  {
    value: "LANDLORD",
    label: "Owner",
    description: "I offer property, land, vehicles, products or services",
    icon: Building,
  },
  {
    value: "AGENT",
    label: "Agent",
    description: "I manage listings and deals for clients and owners",
    icon: Users,
  },
];
...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success("Welcome to Modern Properties!");
      ...
      <div className="hidden flex-col items-center justify-center bg-brand-700 p-12 lg:flex lg:w-1/2">
        <div className="max-w-md text-center">
          ...
          <h2 className="text-3xl font-bold text-white font-display">
            Join Uganda&apos;s property and dealership marketplace
          </h2>
          <p className="mt-4 text-lg text-white/70">
            Create your account to {role === "TENANT" ? "discover listings across Uganda" : "offer property, land, vehicles, products and services"} today.
          </p>
        </div>
      </div>
